...
const About = () => {
  const firstBox = {
    ...
    description: (
      ...
      >
        <p>
          Almost any given Indian cuisine takes 2-3 hours to prepare, cook,
          serve, and clean. Do you ever notice how despite all this effort and
          time, it still takes less than 30 minutes to finish eating it?
        </p>
        <p>It's dreadful.</p>
        <p>
          Our top rated kitchen partners help us curate meals specifically for
          the Indian cuisine experience. Mirchi Meals aims to bring customers
          the best in quality, price, and quantity of meals available in their
          area to enjoy whenever and wherever. Order all your meals for the
          week, get them delivered in one go, and reheat
        </p>
      </div>
    ),
  };
  ...
  const secondBox = {
    ...
    description: (
      <p className="text-left" style={{ padding: "15px", fontSize: "20px" }}>
        Mirchi Meals seeks to alleviate the pressure of having to spend time in
        the kitchen so you can spend more time doing what’s important. Saving
        headaches, one meal at a time.{" "}
      </p>
    ),
  };
